    ...
    texts: {
      lt: {
        ...
        questions: [
          ...
          { t: 3, q: "Ar jis pasiekia aukščiausias medžių šakas?", a: true },
          { t: 3, q: "Ar jis medžioja kitus gyvūnus?", a: false },
      ...
      en: {
        ...
        questions: [
          ...
          { t: 3, q: "Can it reach the highest tree branches?", a: true },
          { t: 3, q: "Does it hunt other animals?", a: false },
    ...
    texts: {
      lt: {
        ...
        questions: [
          ...
          { t: 3, q: "Ar jis gali visam laikui užmigti?", a: true },
          { t: 3, q: "Ar jo viršūnėje gali tyvuliuoti ežeras?", a: true },
          { t: 3, q: "Ar Vezuvijus yra vienas iš jų?", a: true },
          { t: 3, q: "Ar jų būna tik karštuose kraštuose?", a: false },
        ],
      },
      en: {
        word: "Volcano",
        ...
        questions: [
          ...
          { t: 3, q: "Can it fall asleep forever?", a: true },
          { t: 3, q: "Can a lake sit on its top?", a: true },
          { t: 3, q: "Is Vesuvius one of these?", a: true },
          { t: 3, q: "Are they found only in hot countries?", a: false },
        ],
      },
    },
  },
    ...
    texts: {
      lt: {
        ...
        questions: [
          ...
          { t: 3, q: "Ar senovėje juos ragaudavo tik turtingieji?", a: true },
          { t: 3, q: "Ar jie dažniausiai gaminami iš pieno?", a: true },
          { t: 3, q: "Ar jie gaminami tik iš vaisių?", a: false },
        ],
      },
      en: {
        word: "Ice cream",
        ...
        questions: [
          ...
          { t: 3, q: "In ancient times, was it a treat for the rich only?", a: true },
          { t: 3, q: "Is it usually made from milk?", a: true },
          { t: 3, q: "Is it made only from fruit?", a: false },
        ],
      },
    },
  },
    ...
    texts: {
      lt: {
        ...
        questions: [
          ...
          { t: 3, q: "Ar seniau ji spindėjo akinamai baltai?", a: true },
          { t: 3, q: "Ar ji pastatyta Romos imperijos laikais?", a: false },
      ...
      en: {
        ...
        questions: [
          ...
          { t: 3, q: "Did it once shine dazzling white?", a: true },
          { t: 3, q: "Was it built in Roman times?", a: false },
    ...
    texts: {
      lt: {
        ...
        questions: [
          ...
          { t: 3, q: "Ar senovėje jo strėlytė plūduriuodavo vandenyje?", a: true },
      ...
      en: {
        ...
        questions: [
          ...
          { t: 3, q: "Long ago, did its needle float in water?", a: true },
    ...
    texts: {
      lt: {
        ...
        questions: [
          ...
          { t: 3, q: "Ar visos jo kovos baigdavosi mirtimi?", a: false },
      ...
      en: {
        ...
        questions: [
          ...
          { t: 3, q: "Did all of his fights end in death?", a: false },
    ...
    texts: {
      lt: {
        ...
        questions: [
          ...
          { t: 3, q: "Ar ji turi žiedus kaip Saturnas?", a: false },
      ...
      en: {
        ...
        questions: [
          ...
          { t: 3, q: "Does it have rings like Saturn?", a: false },
    ...
    texts: {
      lt: {
        ...
        questions: [
          ...
          { t: 3, q: "Ar jis susidaro iš lavos?", a: false },
      ...
      en: {
        ...
        questions: [
          ...
          { t: 3, q: "Is it made of lava?", a: false },
    ...
    texts: {
      lt: {
        ...
        questions: [
          ...
          { t: 3, q: "Ar jis išrastas tik prieš kelis dešimtmečius?", a: false },
      ...
      en: {
        ...
        questions: [
          ...
          { t: 3, q: "Was it invented only a few decades ago?", a: false },
    ...
    texts: {
      lt: {
        ...
        questions: [
          ...
          { t: 3, q: "Ar jo vardu pavadinta garsi automobilių markė?", a: false },
          ...
          { t: 3, q: "Ar jis svarbus Pelenės pasakoje?", a: false },
        ],
      },
      en: {
        word: "Apple",
        ...
        questions: [
          ...
          { t: 3, q: "Is a famous car brand named after it?", a: false },
          ...
          { t: 3, q: "Does it play a big role in Cinderella's tale?", a: false },
        ],
      },
    },
  },
