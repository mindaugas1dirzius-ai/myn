...
export const DETECTIVE_CASES: DetectiveCase[] = [
  // ── L1 — vaikai (9–12 m.) ─────────────────────────────────────────────
  {
    ...
    texts: {
      lt: {
        ...
        questions: [
          { t: 1, q: "Ar jį sutiksi Europos miškuose?", a: false },
      ...
      en: {
        ...
        questions: [
          { t: 1, q: "Would you meet it in a European forest?", a: false },
    ...
    texts: {
      lt: {
        ...
        questions: [
          ...
          { t: 1, q: "Ar jų yra Europoje?", a: true },
      ...
      en: {
        ...
        questions: [
          ...
          { t: 1, q: "Are there any in Europe?", a: true },
  ...
  },
  {
    ...
    texts: {
      lt: {
        ...
        questions: [
          { t: 1, q: "Ar tai desertas?", a: true },
          { t: 1, q: "Ar tai gėrimas?", a: false },
      ...
      en: {
        ...
        categoryLabel: "Food",
        questions: [
          { t: 1, q: "Is it a dessert?", a: true },
          { t: 1, q: "Is it a drink?", a: false },
  ...
  // ── L2 — paaugliai (12–18 m.) ─────────────────────────────────────────
  {
    ...
    texts: {
      lt: {
        ...
        questions: [
          { t: 1, q: "Ar ji aukštesnė už 10 aukštų namą?", a: true },
          { t: 1, q: "Ar ją galima aplankyti šiandien?", a: true },
      ...
      en: {
        ...
        questions: [
          { t: 1, q: "Is it taller than a 10-story building?", a: true },
          { t: 1, q: "Can you visit it today?", a: true },
  ...
  },
  {
    ...
    texts: {
      lt: {
        ...
        categoryLabel: "Gyvūnas",
        questions: [
          { t: 1, q: "Ar jį galima laikyti namuose?", a: false },
      ...
      en: {
        ...
        categoryLabel: "Animal",
        questions: [
          { t: 1, q: "Can you keep it at home?", a: false },
  ...
  },
  {
    ...
    texts: {
      lt: {
        ...
        questions: [
          { t: 1, q: "Ar jis skleidžia garsą?", a: false },
          { t: 1, q: "Ar jis sunkesnis už plytą?", a: false },
      ...
      en: {
        ...
        questions: [
          { t: 1, q: "Does it make a sound?", a: false },
          { t: 1, q: "Is it heavier than a brick?", a: false },
    ...
    texts: {
      lt: {
        ...
        questions: [
          ...
          { t: 1, q: "Ar tai įvykis (mūšis ar šventė)?", a: false },
      ...
      en: {
        ...
        questions: [
          ...
          { t: 1, q: "Is it an event (a battle or a festival)?", a: false },
  ...
  },
  {
    ...
    texts: {
      lt: {
        ...
        questions: [
          { t: 1, q: "Ar tai sukūrė žmonės?", a: false },
      ...
      en: {
        ...
        categoryLabel: "Space",
        questions: [
          { t: 1, q: "Was it made by humans?", a: false },
  ...
  },
  {
    ...
    texts: {
      lt: {
        ...
        categoryLabel: "Daiktas",
        questions: [
          { t: 1, q: "Ar jis turi judančią dalį?", a: true },
          { t: 1, q: "Ar jis telpa ant stalo?", a: true },
      ...
      en: {
        ...
        categoryLabel: "Object",
        questions: [
          { t: 1, q: "Does it have a moving part?", a: true },
          { t: 1, q: "Does it fit on a table?", a: true },
  ...
  // ── v2 PILOTINĖ BYLA (pilnas formatas: 30 kl., intro, SOS, lenta) ──────
  {
    ...
    texts: {
      lt: {
        ...
        questions: [
          { t: 1, q: "Ar tai saldainis ar kepinys?", a: false },
          { t: 1, q: "Ar tai gėrimas?", a: false },
      ...
      en: {
        ...
        questions: [
          { t: 1, q: "Is it a candy or a pastry?", a: false },
          { t: 1, q: "Is it a drink?", a: false },
  ...
  // ── 5 naujų bylų paketas (po lygius, visos su lentomis) 2026-06-13 ─────
  {
    id: "det_012",
    level: 1,
    texts: {
      lt: {
        word: "Liūtas",
        categoryLabel: "Gyvūnas",
        intro: "Įtariamasis snaudžia beveik visą dieną, bet visi jo bijo…",
        sos: "Jį vadina žvėrių karaliumi.",
        board: [
          "Liūtas", "Tigras", "Šuo", "Katė", "Arklys",
          "Karvė", "Kiaulė", "Avis", "Beždžionė", "Dramblys",
          "Žirafa", "Zebras", "Lokys", "Vilkas", "Lapė",
          "Triušis", "Pelė", "Voverė", "Ežys", "Varlė",
          "Gyvatė", "Vėžlys", "Krokodilas", "Banginis", "Delfinas",
          "Ryklys", "Pingvinas", "Pelėda", "Erelis", "Drugelis",
        ],
        boardEmoji: [
          "🦁", "🐯", "🐶", "🐱", "🐴",
          "🐮", "🐷", "🐑", "🐵", "🐘",
        ...
        questions: [
          { t: 1, q: "Ar jis moka skraidyti?", a: false },
          { t: 1, q: "Ar jis gyvena vandenyje?", a: false },
          { t: 1, q: "Ar jis mažesnis už katę?", a: false },
          { t: 1, q: "Ar jį galima laikyti kaip augintinį?", a: false },
          { t: 2, q: "Ar jis minta mėsa?", a: true },
          { t: 2, q: "Ar jis gyvena Afrikoje?", a: true },
          { t: 2, q: "Ar jis medžioja būryje?", a: "both",
            note: "Dažniausiai medžioja grupė, bet kartais ir vienas." },
          { t: 2, q: "Ar jis dryžuotas?", a: false },
          { t: 3, q: "Ar jo šeimoje dažniausiai medžioja patelės?", a: true },
          { t: 3, q: "Ar patinas turi vešlius karčius?", a: true },
          { t: 3, q: "Ar jo balsas girdimas už kelių kilometrų?", a: true },
          { t: 3, q: "Ar jis greičiausias žemės gyvūnas?", a: false },
        ],
      },
      en: {
        word: "Lion",
        categoryLabel: "Animal",
        intro: "The suspect naps almost all day, yet everyone fears him…",
        sos: "They call him the king of beasts.",
        board: [
          "Lion", "Tiger", "Dog", "Cat", "Horse",
          "Cow", "Pig", "Sheep", "Monkey", "Elephant",
          "Giraffe", "Zebra", "Bear", "Wolf", "Fox",
          "Rabbit", "Mouse", "Squirrel", "Hedgehog", "Frog",
          "Snake", "Turtle", "Crocodile", "Whale", "Dolphin",
          "Shark", "Penguin", "Owl", "Eagle", "Butterfly",
        ],
        boardEmoji: [
          "🦁", "🐯", "🐶", "🐱", "🐴",
          "🐮", "🐷", "🐑", "🐵", "🐘",
        ...
        questions: [
          { t: 1, q: "Can it fly?", a: false },
          { t: 1, q: "Does it live in water?", a: false },
          { t: 1, q: "Is it smaller than a cat?", a: false },
          { t: 1, q: "Can you keep it as a pet?", a: false },
          { t: 2, q: "Does it eat meat?", a: true },
          { t: 2, q: "Does it live in Africa?", a: true },
          { t: 2, q: "Does it hunt in a group?", a: "both",
            note: "Usually the group hunts together, but sometimes alone." },
          { t: 2, q: "Is it striped?", a: false },
          { t: 3, q: "Do the females do most of the hunting?", a: true },
          { t: 3, q: "Does the male have a thick mane?", a: true },
          { t: 3, q: "Can its voice be heard kilometers away?", a: true },
          { t: 3, q: "Is it the fastest land animal?", a: false },
        ],
      },
    },
  },
  {
    ...
    texts: {
      lt: {
        word: "Bananas",
        categoryLabel: "Maistas",
        intro: "Įtariamasis dingo iš vaisių dubens — liko tik žievė…",
        sos: "Beždžionių mėgstamiausias.",
        board: [
          "Obuolys", "Bananas", "Kriaušė", "Apelsinas", "Citrina",
          "Braškė", "Vyšnia", "Arbūzas", "Vynuogė", "Ananasas",
          "Pomidoras", "Agurkas", "Morka", "Bulvė", "Svogūnas",
        ...
        questions: [
          { t: 1, q: "Ar tai gėrimas?", a: false },
          { t: 1, q: "Ar tai saldainis ar kepinys?", a: false },
          { t: 1, q: "Ar tai valgoma žalia (nevirta)?", a: true },
          { t: 1, q: "Ar jis apvalus kaip kamuoliukas?", a: false },
          { t: 2, q: "Ar tai vaisius?", a: true },
          { t: 2, q: "Ar jis geltonas?", a: "both",
            note: "Prinokęs — geltonas, neprinokęs — žalias." },
          { t: 2, q: "Ar jį reikia nulupti?", a: true },
          { t: 2, q: "Ar jis auga šaltuose kraštuose?", a: false },
          { t: 3, q: "Ar jis auga didelėmis kekėmis?", a: true },
          { t: 3, q: "Ar jis auga ant milžiniškos žolės, ne medžio?", a: true },
          { t: 3, q: "Ar filmuose juokingai paslystama ant jo žievės?", a: true },
          { t: 3, q: "Ar iš jo gaminamas garsusis sidras?", a: false },
        ],
      },
      en: {
        word: "Banana",
        categoryLabel: "Food",
        intro: "The suspect vanished from the fruit bowl — only the peel was left…",
        sos: "A monkey's favorite.",
        board: [
          "Apple", "Banana", "Pear", "Orange", "Lemon",
          "Strawberry", "Cherry", "Watermelon", "Grape", "Pineapple",
          "Tomato", "Cucumber", "Carrot", "Potato", "Onion",
        ...
        questions: [
          { t: 1, q: "Is it a drink?", a: false },
          { t: 1, q: "Is it a candy or a pastry?", a: false },
          { t: 1, q: "Can you eat it raw?", a: true },
          { t: 1, q: "Is it round like a ball?", a: false },
          { t: 2, q: "Is it a fruit?", a: true },
          { t: 2, q: "Is it yellow?", a: "both",
            note: "Ripe ones are yellow, unripe ones are green." },
          { t: 2, q: "Do you need to peel it?", a: true },
          { t: 2, q: "Does it grow in cold countries?", a: false },
          { t: 3, q: "Does it grow in big bunches?", a: true },
          { t: 3, q: "Does it grow on giant grass, not a tree?", a: true },
          { t: 3, q: "Do movie characters slip on its peel?", a: true },
          { t: 3, q: "Is the famous cider made from it?", a: false },
        ],
      },
    },
  },
  {
    ...
    texts: {
      lt: {
        word: "Gitara",
        categoryLabel: "Daiktas",
        intro: "Įtariamoji visada atsiduria vakarėlio centre…",
        sos: "Prie laužo be jos — ne vakaras.",
        board: [
          "Gitara", "Bumerangas", "Dviratis", "Automobilis", "Lėktuvas",
          "Laivas", "Traukinys", "Telefonas", "Kompiuteris", "Televizorius",
          "Laikrodis", "Knyga", "Pieštukas", "Žirklės", "Raktas",
          "Kėdė", "Lova", "Veidrodis", "Skėtis", "Akiniai",
          "Batai", "Kepurė", "Kamuolys", "Balionas", "Žvakė",
          "Būgnas", "Fotoaparatas", "Šaukštas", "Kuprinė", "Smuikas",
        ],
        boardEmoji: [
          "🎸", "🪃", "🚲", "🚗", "✈️",
          "🚢", "🚂", "📱", "💻", "📺",
        ...
        questions: [
          { t: 1, q: "Ar ji telpa kišenėje?", a: false },
          { t: 1, q: "Ar ji minkšta?", a: false },
          { t: 1, q: "Ar ja važiuojama?", a: false },
          { t: 1, q: "Ar ji randama virtuvėje?", a: false },
          { t: 2, q: "Ar tai muzikos instrumentas?", a: true },
          { t: 2, q: "Ar ja grojama pirštais?", a: true },
          { t: 2, q: "Ar jai reikia elektros?", a: "both",
            note: "Elektrinei reikia, akustinei — ne." },
          { t: 2, q: "Ar į ją mušama lazdelėmis?", a: false },
          { t: 3, q: "Ar klasikinė jos versija turi šešias stygas?", a: true },
          { t: 3, q: "Ar roko žvaigždės su ja karaliauja scenoje?", a: true },
          { t: 3, q: "Ar grojant ji laikoma po smakru?", a: false },
          { t: 3, q: "Ar jos korpusas medinis su skyle viduryje?", a: true },
        ],
      },
      en: {
        word: "Guitar",
        categoryLabel: "Object",
        intro: "The suspect always ends up at the heart of the party…",
        sos: "No campfire night is complete without it.",
        board: [
          "Guitar", "Boomerang", "Bicycle", "Car", "Airplane",
          "Ship", "Train", "Phone", "Computer", "TV",
          "Watch", "Book", "Pencil", "Scissors", "Key",
          "Chair", "Bed", "Mirror", "Umbrella", "Glasses",
          "Shoes", "Cap", "Ball", "Balloon", "Candle",
          "Drum", "Camera", "Spoon", "Backpack", "Violin",
        ],
        boardEmoji: [
          "🎸", "🪃", "🚲", "🚗", "✈️",
          "🚢", "🚂", "📱", "💻", "📺",
        ...
        questions: [
          { t: 1, q: "Does it fit in a pocket?", a: false },
          { t: 1, q: "Is it soft?", a: false },
          { t: 1, q: "Do you ride it?", a: false },
          { t: 1, q: "Is it found in the kitchen?", a: false },
          { t: 2, q: "Is it a musical instrument?", a: true },
          { t: 2, q: "Do you play it with your fingers?", a: true },
          { t: 2, q: "Does it need electricity?", a: "both",
            note: "Electric ones do, acoustic ones don't." },
          { t: 2, q: "Do you hit it with sticks?", a: false },
          { t: 3, q: "Does the classic version have six strings?", a: true },
          { t: 3, q: "Do rock stars rule the stage with it?", a: true },
          { t: 3, q: "Do you hold it under your chin to play?", a: false },
          { t: 3, q: "Does it have a wooden body with a hole?", a: true },
        ],
      },
    },
  },
  {
    ...
    texts: {
      lt: {
        word: "Kaktusas",
        categoryLabel: "Gamta",
        intro: "Įtariamasis ginkluotas ir nepaprastai kantrus…",
        sos: "Apkabinti jo nesinorės.",
        board: [
          "Vaivorykštė", "Debesis", "Saulė", "Mėnulis", "Žvaigždė",
          "Žaibas", "Sniegas", "Lietus", "Tornadas", "Kalnas",
          "Jūra", "Sala", "Dykuma", "Miškas", "Medis",
          "Gėlė", "Grybas", "Akmuo", "Ugnis", "Ledas",
          "Daigas", "Lapas", "Kaktusas", "Palmė", "Saulėgrąža",
          "Rožė", "Dobilas", "Bambukas", "Kriauklė", "Vėjas",
        ],
        boardEmoji: [
          "🌈", "☁️", "☀️", "🌙", "⭐",
          "⚡", "❄️", "🌧️", "🌪️", "⛰️",
        ...
        questions: [
          { t: 1, q: "Ar tai gyvūnas?", a: false },
          { t: 1, q: "Ar tai dangaus reiškinys?", a: false },
          { t: 1, q: "Ar tai auga vandenyje?", a: false },
          { t: 1, q: "Ar tai rasi Europos miškuose?", a: false },
          { t: 2, q: "Ar tai augalas?", a: true },
          { t: 2, q: "Ar jis žaliuoja visus metus?", a: true },
          { t: 2, q: "Ar jam reikia daug vandens?", a: false },
          { t: 2, q: "Ar jis turi žiedus?", a: "both",
            note: "Žydi, bet retai ir trumpai." },
          { t: 3, q: "Ar jo namai — dykumos?", a: true },
          { t: 3, q: "Ar jo spygliai — pakitę lapai?", a: true },
          { t: 3, q: "Ar jis gali užaugti aukštesnis už namą?", a: true },
          { t: 3, q: "Ar jo vaisiai visada nuodingi?", a: false },
        ],
      },
      en: {
        word: "Cactus",
        categoryLabel: "Nature",
        intro: "The suspect is armed and remarkably patient…",
        sos: "You won't want to hug it.",
        board: [
          "Rainbow", "Cloud", "Sun", "Moon", "Star",
          "Lightning", "Snow", "Rain", "Tornado", "Mountain",
          "Sea", "Island", "Desert", "Forest", "Tree",
          "Flower", "Mushroom", "Rock", "Fire", "Ice",
          "Sprout", "Leaf", "Cactus", "Palm", "Sunflower",
          "Rose", "Clover", "Bamboo", "Seashell", "Wind",
        ],
        boardEmoji: [
          "🌈", "☁️", "☀️", "🌙", "⭐",
          "⚡", "❄️", "🌧️", "🌪️", "⛰️",
        ...
        questions: [
          { t: 1, q: "Is it an animal?", a: false },
          { t: 1, q: "Is it a sky phenomenon?", a: false },
          { t: 1, q: "Does it grow in water?", a: false },
          { t: 1, q: "Would you find it in a European forest?", a: false },
          { t: 2, q: "Is it a plant?", a: true },
          { t: 2, q: "Is it green all year round?", a: true },
          { t: 2, q: "Does it need lots of water?", a: false },
          { t: 2, q: "Does it have flowers?", a: "both",
            note: "It blooms, but rarely and briefly." },
          { t: 3, q: "Is the desert its home?", a: true },
          { t: 3, q: "Are its spikes actually changed leaves?", a: true },
          { t: 3, q: "Can it grow taller than a house?", a: true },
          { t: 3, q: "Are its fruits always poisonous?", a: false },
        ],
      },
    },
  },
  {
    ...
    texts: {
      lt: {
        word: "Bumerangas",
        categoryLabel: "Daiktas",
        intro: "Byla, kuri vis grįžta ant detektyvo stalo…",
        sos: "Paleisk — ir jis grįš.",
        board: [
          "Gitara", "Bumerangas", "Dviratis", "Automobilis", "Lėktuvas",
          "Laivas", "Traukinys", "Telefonas", "Kompiuteris", "Televizorius",
          "Laikrodis", "Knyga", "Pieštukas", "Žirklės", "Raktas",
        ...
        questions: [
          { t: 1, q: "Ar jis didesnis už žmogų?", a: false },
          { t: 1, q: "Ar jam reikia baterijų?", a: false },
          { t: 1, q: "Ar jis naudojamas virtuvėje?", a: false },
          { t: 1, q: "Ar jis minkštas?", a: false },
          { t: 2, q: "Ar jis skirtas mesti?", a: true },
          { t: 2, q: "Ar jis dažniausiai medinis?", a: true },
          { t: 2, q: "Ar jis apvalus kaip diskas?", a: false },
          { t: 2, q: "Ar jis gimė kaip medžioklės įrankis?", a: true },
          { t: 3, q: "Ar jo skrydžio kelias — lankas?", a: true },
          { t: 3, q: "Ar jį išrado Australijos aborigenai?", a: "both",
            note: "Garsiausi — aborigenų, bet seniausias rastas Europoje." },
          { t: 3, q: "Ar jo vardu vadinami sugrįžtantys dalykai?", a: true },
          { t: 3, q: "Ar juo šaudoma strėlėmis?", a: false },
        ],
      },
      en: {
        word: "Boomerang",
        categoryLabel: "Object",
        intro: "A case that keeps coming back to the detective's desk…",
        sos: "Let it go — and it returns.",
        board: [
          "Guitar", "Boomerang", "Bicycle", "Car", "Airplane",
          "Ship", "Train", "Phone", "Computer", "TV",
          "Watch", "Book", "Pencil", "Scissors", "Key",
        ...
        questions: [
          { t: 1, q: "Is it bigger than a person?", a: false },
          { t: 1, q: "Does it need batteries?", a: false },
          { t: 1, q: "Is it used in the kitchen?", a: false },
          { t: 1, q: "Is it soft?", a: false },
          { t: 2, q: "Is it made for throwing?", a: true },
          { t: 2, q: "Is it usually wooden?", a: true },
          { t: 2, q: "Is it round like a disc?", a: false },
          { t: 2, q: "Was it born as a hunting tool?", a: true },
          { t: 3, q: "Does it fly in a curved path?", a: true },
          { t: 3, q: "Was it invented by Australian Aboriginals?", a: "both",
            note: "The most famous are Aboriginal, but the oldest was found in Europe." },
          { t: 3, q: "Is its name used for things that come back?", a: true },
          { t: 3, q: "Does it shoot arrows?", a: false },
        ],
      },
    },
  },
