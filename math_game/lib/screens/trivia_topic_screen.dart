      ...
      case 'brands':
        return [
          _SubTheme(
            id: 'food',
            emoji: '🍟',
            title: s.subBrandsFood,
            subtitle: s.subBrandsFoodDesc,
            accent: AppColors.levelHard,
            open: true,
          ),
          _SubTheme(
            id: 'fashion',
            emoji: '👟',
            title: s.subBrandsFashion,
            subtitle: s.subBrandsFashionDesc,
          ...
          _SubTheme(
            id: 'cars',
            emoji: '🚗',
            title: s.subBrandsCars,
            subtitle: s.subBrandsCarsDesc,
            accent: AppColors.neonBlue,
            open: true,
          ),
          _SubTheme(
      ...
      case 'mythology':
        return [
          _SubTheme(
            id: 'greek',
            emoji: '⚡',
            title: s.subMythGreek,
            subtitle: s.subMythGreekDesc,
            accent: AppColors.levelHard,
            open: true,
          ),
          _SubTheme(
            id: 'norse',
            emoji: '🔨',
            title: s.subMythNorse,
            subtitle: s.subMythNorseDesc,
            accent: AppColors.neonBlue,
            open: true,
          ),
          _SubTheme(
          ...
          _SubTheme(
            id: 'creatures',
            emoji: '🐉',
            title: s.subMythCreatures,
            subtitle: s.subMythCreaturesDesc,
            accent: AppColors.levelExtreme,
            open: true,
          ),
          _SubTheme(
