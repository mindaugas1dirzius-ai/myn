                  ...
                  child: Column(
                    children: [
                      ...
                      _modeCard(
                        ...
                        subtitle: t(
                            'Pirk TAIP/NE užuominas ir apkaltink vieną iš 30 įtariamųjų',
                            'Buy YES/NO clues and accuse one of 30 suspects'),
                        accent: AppColors.correct,
                        builder: (_) => const DetectiveScreen(variant: 2),
                      ),
                      const SizedBox(height: 14),
                      _modeCard(
                        context,
                        emoji: '✍️',
                        title: t('Detektyvas PRO', 'Detective PRO'),
                        subtitle: t(
                            'Be pasiūlymų — žodį įrašyk PATS. Sunkiau, bet +25 % premija',
                            'No suspect list — TYPE the word yourself. Harder, +25% bonus'),
                        accent: AppColors.wrong,
                        builder: (_) => const DetectiveScreen(variant: 1),
                      ),
                    ],
                  ),
                ),
