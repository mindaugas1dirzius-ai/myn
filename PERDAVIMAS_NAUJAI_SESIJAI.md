...
- **KAS TOLIAU (eilės tvarka):**
  1. **🔤 KLAUSIMŲ STILIUS — perfrazuoti (savininkas patvirtino 2026-06-13):** NEpradėti klausimų monotonišku „Kuris…?"; ĮVAIRIOS pradžios + APRAŠOMOJI (kabliuko) forma be klaustuko (METODIKA §10 „SPĄSTAS #1b"). Pvz. „Kuris vabzdys naktį sukuria švytinčią šviesą?" → „Vabzdys, naktį sukuriantis savo švytinčią šviesą".
     - ✅ **PADARYTA 2 Gamtos potemėms (2026-06-13):** Supergalios + Gyvūnų protas. LENGVAS lygiai buvo 10/10 ir 8/10 „Kuris" → dabar subalansuotas MIŠINYS (aprašomieji + „Kuris…?" + Ką/Kaip/Kuo…), jokių „Kuris" sankaupų. 25 klausimai perfrazuoti (LT+EN), keista TIK `question` (atsakymai/faktai nepaliesti). Patikra: validateContent 0 kl., tsc OK, ilgio kvapas 0. Deploy `startNatureGame` (turinys serveryje, APK nereikia).
